...
class dashboardUI(QMainWindow):
    def __init__(self,value,parent = None):
        ...
        self.userData = {"username":self.reg["username"],"password":self.reg['password'],"role":"U","msg": ["hello",'hi'],"pending":{"festival":{"name":"","loc":"","date":"","image":"0"},"tourGuide":{"name":"","loc":"","rating":"0"}},'name':self.reg['name'],"age":self.reg['age'],"sex":
                        self.reg['sex'],"Location":self.reg['loc'],"EmailAd":self.reg["email"],"started":self.reg['started'],"FavoriteLoc":self.reg['favloc'],"TotalTours":"0","contact":self.reg['contact'],"aboutme":"I have no bio data yet to show the people",
                        "membership":'1'}
        #profile details
        self.name = self.reg["name"]
        self.email = self.reg["email"]
        self.location = self.reg["loc"]
        self.username = self.reg['username']
...
#------------------------Left Portion---------------------------------------------------------------
        ...
        self.BioText=QLabel(self.bio,self)
        self.BioText.setWordWrap(True)
...
#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>     
        ...
        self.RatingsText=QLabel(0,self)
...
#----------------PROFILE INFORMATION-----------------------------------------------------------------
        ...
        self.FullNameT=QLabel(self.reg["name"],self)
        ...
        self.AgeT=QLabel(self.reg['age'],self)
        ...
        self.SexT=QLabel(self.reg['sex'],self)
        ...
        self.EmailT=QLabel(self.reg['email'],self)
        ...
        self.EmailT=QLabel(self.reg['contact'],self)
