...
class BookPopUp(QWidget):
    ...
    def Design(self):
        ...
        self.PortionA.setPixmap(QPixmap("Book-left.jpg"))
        self.PortionB.setPixmap(QPixmap("Book-right2.jpg"))
    ...
    def LeftPortion(self):
        ...
        self.Profile.setPixmap(QPixmap("BlankIcon.png"))
        ...
        border: 5px solid;border-color:Transparent;border-radius: 5px;background-color:#000000;color:#FFFFFF;
    ...
    def RightPortion(self):
        ...
        self.Star=QPixmap("StarYellow1.png")#2B2F36 canvas (Darker)
...
#--------------------------------------------------
        self.Picture1=QPixmap("Ibalong.1.jpg")
        self.Picture2=QPixmap("Katalingkasan.1.jpg")
